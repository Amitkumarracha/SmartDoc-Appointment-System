...
import com.smartdoc.dto.AppointmentDTO;
import com.smartdoc.dto.UserDTO;
...
public class ExceptionHandlerUtil {
    ...
    public void validateAppointment(AppointmentDTO appointmentDTO) throws AppointmentException {
        if (appointmentDTO.getDoctorId() == null || appointmentDTO.getPatientId() == null) {
    ...
    public void completeAppointmentBooking(AppointmentDTO appointmentDTO, double paymentAmount) {
        try {
            ...
            checkDoctorAvailability(appointmentDTO.getDoctorId(), appointmentDTO.getStartTime());
            checkSlotAvailability(appointmentDTO.getDoctorId(), 
